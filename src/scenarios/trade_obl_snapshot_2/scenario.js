...
class Scenario {
        ...
        pubsub.subscribe('cmd', (cmd) => {
            ...
            if (!isNaN(cmd)) {
                ...
                if (!isNaN(cmd)) {
                    ...
                    // this.chart.update_obl_draw_accomulative(idx);
                    // this.chart.update_obl_draw_moving_sum(idx, 2);
                    this.chart.update_obl_draw_with_vp(idx, 13 * 3600000);
                }
    ...
    async load_trades() {
        let [t, t_end, n, l, v, b, s] = await binary_file_reader("trades_chart_data", "size_t,size_t,size_t,size_t,double,double,double");
        this.chart.tls = {t: t, t_end: t_end, n: n, l: l, v: v, b: b, s: s};
